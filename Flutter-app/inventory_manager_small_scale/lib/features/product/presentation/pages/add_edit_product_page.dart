...
class _AddEditProductPageState extends State<AddEditProductPage> {
  ...
  void _saveProduct() {
    if (_formKey.currentState!.validate()) 
    {
      ...
      if (_isEditing) {
        context.read().add(UpdateProductEvent(product));
      } else {
        context.read().add(CreateProductEvent(product));
      }
    }
  }
    ...
    return Column(
      ...
      [
        ...
        (
          ...
          decoration: AppStyles.inputDecoration(labelText: '', hintText: 'Select or enter category'),
        ...
        TextFormField(
          ...
          decoration: AppStyles.inputDecoration(labelText: '', hintText: 'Enter category'),
          validator: (value){
        ...
        ...[
          ...
          TextFormField(
            controller: _categoryController,
            decoration: AppStyles.inputDecoration(labelText: '', hintText: 'Enter new category'),
            validator: (value)
            {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        [
          ...
          ) // This is a real comment wtf is this bloc builder comment showing up on vscode so annoying
        ],
      ),
                    ...
                    children: [
                      ...
                      (
                        ...
                        [
                          ...
                          // spacing between elements of rows
                        ...
                        ],  // ENding the childern of the row
                      ),

                      //Spacing before next column entry
